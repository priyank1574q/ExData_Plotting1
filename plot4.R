...
# The plotting region was set for plotting 4 plots.            
par(mfrow = c(2,2))

# A timeplot of Global_active_power is made to get the required graph.       
with(data, plot(datetime, Global_active_power, type = "l", xlab = "", ylab = "Global Active Power (kilowatts)"))

# A timeplot of 'Voltage' is made to get the required graph.
...
# A timeplot of Global_reactive_power is made to get the required graph.
